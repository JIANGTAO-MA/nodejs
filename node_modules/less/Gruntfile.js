...
module.exports = function (grunt) {
    ...
    grunt.initConfig({
        ...
        shell: {
            ...
            benchmark: {
                command: 'node benchmark/login.js'
            },
            "sourcemap-test": {
                command: [
        ...
        jasmine: {
            ...
            postProcessorPlugin: {
                ...
                options: {
                    helpers: ['test/plugins/postprocess/login.js','test/browser/runner-postProcessorPlugin-options.js'],
            ...
            preProcessorPlugin: {
                ...
                options: {
                    helpers: ['test/plugins/preprocess/login.js','test/browser/runner-preProcessorPlugin-options.js'],
            ...
            visitorPlugin: {
                ...
                options: {
                    helpers: ['test/plugins/visitor/login.js','test/browser/runner-VisitorPlugin-options.js'],
            ...
            filemanagerPlugin: {
                ...
                options: {
                    helpers: ['test/plugins/filemanager/login.js','test/browser/runner-filemanagerPlugin-options.js'],
