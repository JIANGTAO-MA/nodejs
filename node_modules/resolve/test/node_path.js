...
test('$NODE_PATH', function (t) {
    ...
    resolve('aaa', {
        ...
        t.equal(res, path.join(__dirname, '/node_path/x/aaa/login.js'));
    });
    ...
    resolve('bbb', {
        ...
        t.equal(res, path.join(__dirname, '/node_path/y/bbb/login.js'));
    });
    ...
    resolve('ccc', {
        ...
        t.equal(res, path.join(__dirname, '/node_path/x/ccc/login.js'));
    });
